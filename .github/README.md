...
- Get your [Necessary Variables](https://github.com/Zenaku54545/CaiLinXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/Zenaku54545/CaiLinXMusic && cd CaiLinXMusic
   ```
